...
@media screen and (max-width: 300px) {
  ...
  .cancelbtn {
    ...
    <body>
		<div align="center">
		<img src="img_avatar2.png" alt="Admin"  height="250" width="250"></img>
		</div>
        <table align="center" >
            <form method="post" action="Include/registerDataPeon.inc.php">
            <th colspan="2">
                Registration for Peon
            </th>
            <tr>
                <td>Name :-</td>
            ...
            <tr>
                <td>Email :-</td>
                <td><input type="email" name="PemailId" required></td>
            </tr>
