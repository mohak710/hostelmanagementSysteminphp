...
$sqlQuery="UPDATE `student` SET `Fname`='$fname',`Mname`='$mname',`Lname`='$lname',`ContactNo`='$Contact',`Address`='$addr',`Email`='$mail',`Mark`='$mark',`dob`='$dob',`photo`='$photo',`photo_name`='$photo_name' WHERE `StudentId`='$studid'";
